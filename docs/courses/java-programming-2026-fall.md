...
description: 高校计算机与软件工程专业《Java程序设计》（2026秋季学期）完整教学大纲与授课资源中心。全面涵盖 Java 核心语法基础、面向对象三大特性与类设计、异常处理与常用工具类、JVM 内存结构模型与多线程并发编程，以及 Socket 网络通信与物联网边缘网关工业项目实操。支持各讲高清课件下载与随堂任务自测。
head:
  - - meta
    - name: keywords
