...
layout: doc
title: 离散数学 (2026春季)
breadcrumb: 离散数学 (2026春季)
description: 计算机科学与技术等专业《离散数学》（2026春季学期结课归档）教学大纲、章节课件与复习专题讲义。内容涵盖命题逻辑、一阶逻辑、二元关系、等价与偏序、图论及代数结构。
head:
  - - meta
    - name: keywords
...
# 离散数学 <span class="subtitle">2026 春季学期归档</span>

《离散数学》是计算机类专业常见的基础课程，内容包括命题逻辑、一阶逻辑、二元关系和图论基础等。本页面为 **2026 春季学期（已结课）** 授课课件与复习讲义归档。
