...
description: 二阶常系数齐次线性微分方程三类通解几何直观解析教学指南。通过交互图文与动态响应曲线，深入剖析特征方程求根判别式与解的结构演变规律：实不相等特征根对应的双重衰减或增长、二重实根对应的临界阻尼转折点，以及共轭复根产生的简谐振荡与阻尼衰减振动物理模式。帮助理工科学生告别机械套公式，建立深刻的动力学物理直觉。
layout: doc
---
